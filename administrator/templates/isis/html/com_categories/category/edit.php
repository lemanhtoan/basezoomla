...
<?php 
	$current_extension = JRequest::getVar('extension');
	if($current_extension == 'com_product'):
?>
<script type="text/javascript">
	jQuery(function($) {
		$(window).load(function() {
			var message = $('#image_size_notice').val();
			$('#jform_params_image-lbl').parent().parent().append('<div class="control-label">&nbsp;</div><div class="controls"><p style="margin-top: 10px; color: #7F7F7F">' + message +'</p></div>');
		});
	});
</script> 
<?php endif; ?>
<input type="hidden" id="image_size_notice" value="<?php echo JText::_('IMAGE_SIZE_NOTICE') ?>">
