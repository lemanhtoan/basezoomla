		...
		?>
			<tr class="<?php echo "row".$k;?>">
				...
				<td align="center" class="vm-order">
					...
					<?php if($cat->ordering == 1 || $cat->ordering == 0): ?>
						<span style="display: block; text-align: center; width: 50%"><?php echo $cat->ordering; ?></span>
					<?php else: ?>
					<input data-order="<?php echo $cat->ordering ?>" maxlength="2" class="ordering" type="text" name="order[<?php echo $i?>]" id="order[<?php echo $i?>]" size="5" value="<?php echo $cat->ordering; ?>" style="text-align: center" />
					<?php endif; ?>
