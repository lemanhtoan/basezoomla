...
<fieldset>
    ...
    <table class="adminform" width="100%" style="border: 0">
	    ...
	    <!-- <tr>
	        ...
	        <td width="140px">
	            <input
	                ...
	                value="<?php echo $this->product->allPrices[$this->product->selectedPrice]['product_price']; ?>"/>
	            <input type="hidden"
...
<?php if($this->product->product_parent_id == 0): ?>
    ...
    <table border="0" width="100%" cellpadding="2" cellspacing="3" id="mainPriceTable" class="adminform  ">
		...
		foreach ($this->product->allPrices as $k => $sPrices) {
			...
			?>
        <tr id="<?php echo $tmpl ?>" class="removable row<?php echo $rowColor?>" style="border: 0">
	            <td width="100%">
