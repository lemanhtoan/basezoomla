...
defined('_JEXEC') or die('Restricted access');?>
   <table class="adminform dimensions">
   <tbody>

    <tr class="row1">
		<th style="text-align:left;"><?php echo vmText::_('COM_VIRTUEMART_PRODUCT_LENGTH') ?>
      </th>
      <td width="79%">
    ...
    <tr class="row0">
		<th style="text-align:left;"><?php echo vmText::_('COM_VIRTUEMART_PRODUCT_WIDTH') ?></th>
      <td>
        <input type="text" class="inputbox"  name="product_width" value="<?php echo $this->product->product_width; ?>" size="15" maxlength="15" />
      </td>
    </tr>
    <tr class="row1">
		<th style="text-align:left;"><?php echo vmText::_('COM_VIRTUEMART_PRODUCT_HEIGHT') ?></th>
      <td>
