...
<?php $rowColor = 1 - $rowColor; ?>
    <tr class="row<?php echo $rowColor?>" style="border: 0">
        ...
        <!-- <td colspan="3">
            <div style="margin-right: 20px; display: inline">
                    ...
                    <?php
                        ...
                        // echo VmHtml::radioList ('mprices[us+e_desired_price][' . $this->priceCounter . ']', $this->product->override, $options);
    ...
    <!-- <tr>
        <td>
            ...
            <input type="text"
                   size="12"
                   style="text-align:right; display: none" name="mprices[price_quantity_start][]"
                   value="1" />
        </td>
        <td>
            <br/>
