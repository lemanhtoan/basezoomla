...
<?php endif;?>
	...
	<legend class="element-invisible"><?php echo JText::_('COM_USERS_SEARCH_USERS'); ?></legend>
		...
		<div class="filter-select">
            ...
            <select name="filter_user_retail_group" id="filter_user_retail_group">
				<option value="*"><?php echo JText::_('COM_USERS_FILTER_ACTIVE_FAIT');?></option>
				<?php echo JHtml::_('select.options', UsersHelper::getActiveFaitOptions(), 'value', 'text', $this->state->get('filter.user_retail_group'));?>
			</select>
