...
<table class="adminlist table" style="table-layout: fixed;">
	<tr>
		...
		<table class="adminlist" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td class="key"><strong><?php echo vmText::_('Additional Information') ?></strong></td>
				<td><?php echo $this->orderbt->additional_infor; ?></td>
			</tr>
			<?php
...
&nbsp;
<table width="100%" style="display:block !important;">
	<tr>
