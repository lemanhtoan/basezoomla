			...
			<tr class="row<?php echo $k; ?>">
				...
				<td>
					...
					if ($order->virtuemart_user_id) {
                        ...
                        $userlink = JROUTE::_ ('index.php?option=com_users&task=user.edit&id=' . $order->virtuemart_user_id, FALSE);
				...
				-->
				<!-- Total -->
				<td><?php echo number_format($order->order_billTaxAmount, 2, '.', '') .' CHF';//order_total; ?></td>
