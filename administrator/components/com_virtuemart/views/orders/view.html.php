...
class VirtuemartViewOrders extends VmViewAdmin {
	...
	function display($tpl = null) {
		...
		if ($curTask == 'edit') {
			...
			//edit shipping data
			if ( $orderst->street_shipping ) $orderst->address_1 = $orderst->street_shipping;
			if ( $orderst->city_shipping ) $orderst->city = $orderst->city_shipping;
			if ( $orderst->zipcode_shipping ) $orderst->zip = $orderst->zipcode_shipping;
			if ( $orderst->country_shipping ) $orderst->virtuemart_country_id = $orderst->country_shipping;
