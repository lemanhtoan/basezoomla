...
document.getElementById('calc_kind').value = 'TaxBill';
document.getElementById('calc_value_mathop').value = '+%';

var elem = document.getElementById("calc_currency");
selectedNode = elem.options[0];
document.getElementById('calc_currency').value = selectedNode.value;
</script>