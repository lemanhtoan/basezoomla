...
class UsersHelper
{
    ...
    public static function getActiveFaitOptions()
	{
		// Build the filter options.
		$options = array();
		$options[] = JHtml::_('select.option', 'user_opticoach', JText::_('Opticoach'));
		$options[] = JHtml::_('select.option', 'user_independent', JText::_('Independent'));
