...
<form action="<?php echo JRoute::_('index.php?option=com_subscribe&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="subscribe-form" class="form-validate">
    ...
    <div class="form-horizontal">
        ...
        <div class="row-fluid">
			...
			<div class="control-group">
				<div class="control-label"><?php echo $this->form->getLabel('register'); ?></div>
				<div class="controls"><?php echo $this->form->getInput('register'); ?></div>
			</div>
