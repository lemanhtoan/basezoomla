...
class SlideshowModelSlideshow extends JModelAdmin
{
	 ...
	 * @since	1.6
	 */
	protected $text_prefix = 'COM_SLIDESHOW';
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		// Get the form.
		$form = $this->loadForm('com_slideshow.slideshow', 'slideshow', array('control' => 'jform', 'load_data' => $loadData));
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_slideshow.edit.slideshow.data', array());
