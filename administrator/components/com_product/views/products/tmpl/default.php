...
<?php endif;?>
		...
		<table class="table table-striped" id="productList">
			<thead>
				...
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_PRODUCT_PRODUCTS_IMAGE_HOVER', 'a.image_hover', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_PRODUCT_PRODUCTS_CATEGORY_ID', 'a.category_id', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_PRODUCT_PRODUCTS_FRAME_WIDTH', 'a.frame_width', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_PRODUCT_PRODUCTS_FRAME_HEIGHT', 'a.frame_height', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_PRODUCT_PRODUCTS_LENS_WIDTH', 'a.lens_width', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_PRODUCT_PRODUCTS_TEMPLE_ARMS', 'a.temple_arms', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_PRODUCT_PRODUCTS_BRIDGE', 'a.bridge', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_PRODUCT_PRODUCTS_COLOURS', 'a.colours', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_PRODUCT_PRODUCTS_LANGUAGE', 'a.language', $listDirn, $listOrder); ?>
				</th>
			...
			<?php foreach ($this->items as $i => $item) :
				...
				<td>
                    <img src="../<?php echo $item->image; ?>" width="160px" height="50px"/>
				</td>
				<td>
                    <img src="../<?php echo $item->image_hover; ?>" width="160px" height="50px"/>
				</td>
				<td>
				...
				<td>
					...
					<?php echo $item->frame_width; ?>
				</td>
				<td>

					<?php echo $item->frame_height; ?>
				</td>
				<td>

					<?php echo $item->lens_width; ?>
				</td>
				<td>

					<?php echo $item->temple_arms; ?>
				</td>
				<td>

					<?php echo $item->bridge; ?>
				</td>
				<td>

					<?php echo $item->colours; ?>
				</td>
				<td>
