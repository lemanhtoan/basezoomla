 ...
 */
class ProductModelColours extends JModelList {
    ...
    protected function getListQuery() {
        ...
        $query->from('`#__product_colours` AS a');
        ...
        if (!empty($search)) {
            if (stripos($search, 'id:') === 0) {
                ...
                $query->where('( a.name LIKE '.$search.'  OR  a.image LIKE '.$search.'  OR  a.language LIKE '.$search.' )');
            }
        }
