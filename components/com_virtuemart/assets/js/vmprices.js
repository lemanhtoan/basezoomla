...
Virtuemart.cartEffect = function(form) {
    ...
    var lang_tag = jQuery('#ajax_url').val();
    ...
    jQuery.ajax({
        ...
        cache: false,
        dataType: "json",
        url: window.vmSiteurl + "index.php?option=com_virtuemart&nosef=1&view=cart&task=addJS&format=json&"+lang_tag,
        data: dat
    }).done(

	function(datas, textStatus) {
       jQuery('.modViewCartContainer').html(datas.cart_html);
        //alert(datas.cart_html);
		if(datas.stat ==1){
			var txt = datas.msg;
