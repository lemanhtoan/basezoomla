...
class VirtueMartViewCart extends VmView {
	...
	public function display($tpl = null) {
		...
		if (!$this->layoutName && !vRequest::getCmd('layout', '') ) $this->layoutName = vRequest::getCmd('layout', 'default');
		//var_dump($this->layoutName); die;
		...
		if ($this->layoutName == 'select_shipment') {
			...
			if ( !vRequest::getCmd('layout', '') ) 
			{
				$this->layoutName = $this->cart->layout; //using layout pass to
