...
echo '<div class="div-left"> <a class="continue_link" id="abcd" >' . vmText::_('COM_VIRTUEMART_CONTINUE_SHOPPING') . '</a></div>'; //$this->continue_link 
echo '<div class="div-right"> <a class="showcart floatright" href="' . $this->cart_link . '">' . vmText::_('COM_VIRTUEMART_CART_SHOW') . '</a></div>';
...
<script type="text/javascript">
	jQuery(document).ready(function() {
         jQuery('#abcd').click(function() {
         	jQuery('#fancybox-wrap, #fancybox-overlay').css('display', 'none');
            //jQuery('#fancybox-wrap').css('position', 'static');
         });
	});
</script>
