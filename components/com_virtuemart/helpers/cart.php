...
class VirtueMartCart {
	...
	public function updateProductCart() {
		...
		$quantities = vRequest::getInt('quantity');//echo "<pre>"; var_dump($quantities);die;
		if(empty($quantities)) return false;
		$updated = false;

		foreach($quantities as $key=>$quantity){
			if (isset($this->cartProductsData[$key]) and !empty($quantity) and !isset($_POST['delete_'.$key])) {//echo "<pre>";var_dump($key,$this->cartProductsData);
		...
		//echo "<pre>";var_dump($quantities);die;
