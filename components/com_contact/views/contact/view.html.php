...
require_once JPATH_COMPONENT . '/helpers/maps.php';
...
class ContactViewContact extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$user = JFactory::getUser();
		if(!$user->guest) {
			$this->user_infomation = ContactModelContact::getUserInfomations($user->id);
		}
		// Get the parameters
		...
		$this->maps = ContactHelperMaps::getMaps();
