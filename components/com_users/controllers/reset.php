...
class UsersControllerReset extends UsersController
{
	...
	public function confirm()
	{
		...
		else
		{
			...
			$itemid = UsersHelperRoute::getResetRoute();
			$itemid = $itemid !== null ? '&Itemid=' . $itemid : '';
			$route	= 'index.php?option=com_users&view=reset&layout=complete' . $itemid . '&comp-show=1';
	...
	public function complete()
	{
		...
		else
		{
			...
			$itemid = $itemid !== null ? '&Itemid=' . $itemid : '';
			//$route  = 'index.php?option=com_users&view=login' . $itemid. '&comp-change=1';
            $route	= 'index.php?option=com_users&view=reset&layout=complete' . $itemid . '&comp-change=1';
